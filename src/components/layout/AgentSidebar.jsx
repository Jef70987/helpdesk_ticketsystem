          ...
          <div className="flex items-center justify-between px-4 py-2.5">
            ...
            >
              <div className="flex flex-col leading-tight">
                <h1 className="text-white font-bold text-sm leading-tight">SUPPORT</h1>
                <h2 className="text-gray-400 text-[10px] font-bold leading-tight">AGENT</h2>
              </div>
            </button>
            <button 
            ...
            <div className={`flex items-center ${isCollapsed ? 'flex-col' : 'space-x-4'}`}>
              {!isCollapsed ? (
                <div className="flex flex-col">
                  <h1 className="text-white font-black text-2xl leading-tight tracking-wider">SUPPORT</h1>
                  <h2 className="text-gray-400 text-xs font-bold tracking-widest">AGENT</h2>
                </div>
              ) : (
                <div className="flex flex-col items-center">
                  <h1 className="text-white font-black text-2xl leading-tight">S</h1>
                </div>
              )}
            </div>
          ...
          <div className={`transition-all duration-300 text-white ${isCollapsed ? 'text-xs' : 'text-sm'}`}>
            {!isCollapsed ? (
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-500 font-semibold">Support Agent Panel</p>
              </div>
            ) : (
              <div className="flex flex-col items-center">
