          ...
          <div className="flex items-center justify-between px-4 py-2.5">
            ...
            >
              <div className="flex flex-col leading-tight">
                <h1 className="text-[#000000] font-bold text-sm leading-tight font-['Inter']">TICKET</h1>
                <h2 className="text-[#76777d] text-[10px] font-bold leading-tight font-['JetBrains_Mono'] tracking-[0.05em]">SYSTEM</h2>
              </div>
            </button>
            <button 
            ...
            <div className={`flex items-center ${isCollapsed ? 'flex-col' : 'space-x-4'}`}>
              {!isCollapsed ? (
                <div className="flex flex-col">
                  <h1 className="text-[#000000] font-black text-2xl leading-tight tracking-wider font-['Inter']">TICKET</h1>
                  <h2 className="text-[#76777d] text-xs font-bold tracking-[0.05em] font-['JetBrains_Mono']">SYSTEM</h2>
                </div>
              ) : (
                <div className="flex flex-col items-center">
                  <h1 className="text-[#000000] font-black text-2xl leading-tight font-['Inter']">T</h1>
                </div>
              )}
            </div>
          ...
          <div className={`transition-all duration-300 text-[#000000] ${isCollapsed ? 'text-xs' : 'text-sm'}`}>
            {!isCollapsed ? (
              <div className="space-y-1">
                ...
                <p className="text-xs text-[#76777d] font-semibold font-['JetBrains_Mono'] tracking-[0.05em]">Ticket System</p>
              </div>
            ) : (
              <div className="flex flex-col items-center">
